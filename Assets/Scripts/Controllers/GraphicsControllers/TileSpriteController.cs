...
public class TileSpriteController : MonoBehaviour {
    ...
    void Start() {
        ...
        foreach (Tile tile in World.world.tiles) {
            ...
            GameObject gameObjectBorder = new GameObject(tile.name + "_Border");
            ...
            SpriteRenderer sRTile = gameObjectTile.AddComponent<SpriteRenderer>();
            SpriteRenderer sRBorder = gameObjectBorder.AddComponent<SpriteRenderer>();

            sRTile.sortingLayerName = "Tiles";
            sRBorder.sortingLayerName = "Infrastructure";
            sRBorder.sprite = borderSprite;
